...
"images/icons/bot_16.gif" );
        Image icon  = null;
        if ( iconURL != null ) { icon = new ImageIcon(
iconURL.getPath() ).getImage();  }
...
class RescueArea extends SimDrawPanel
{
    ...
    private void paintWinner( Graphics2D g2 , Color color,  String text)
    {          
        if(text != null)
        {
    ...
    private void paintObjects( Graphics2D g2)
    {
        ...
        paintWinner(g2, Simulator.winColor, Simulator.winText);
    }
}
...
class SensCoverage extends SimDrawPanel
{
    ...
    private static String[] drop1Strings = { "Team1", "Team2",
"Seeker1", "Seeker2", "Defender1", "Defender2" };
    private static String[] drop2Strings = { "Team1", "Team2",
"Seeker1", "Seeker2", "Defender1", "Defender2" };

    private static JPanel dropDownP1 = new JPanel();//(new
FlowLayout(FlowLayout.CENTER, 2, 2));
    private static JPanel dropDownP2 = new JPanel();//(new
FlowLayout(FlowLayout.CENTER, 2, 2));
...
tmrSim.setDelay( sldSpeed.getValue() ); }
        ...
        addConfiguredButton( jpCtrl, btnScreenshot, new ActionListener()
        {
            public void actionPerformed( ActionEvent e )
            {
                ...
                String currentDate   = sdf.format(
Calendar.getInstance( TimeZone.getDefault() ).getTime() );
                String outFileName   = "images/screenshots/screen_" +
currentDate + ".png";
